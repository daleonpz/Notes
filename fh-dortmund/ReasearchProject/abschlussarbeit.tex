...
%%%% === Verzeichnisse (TOC, LOF, LOT, BIB) ===
   ...
   %pointednumbers,  % Ãœberschriftnummerierung mit Punkt, siehe DUDEN !
   %pointlessnumbers, % Ãœberschriftnummerierung ohne Punkt, siehe DUDEN !
...
\newcommand*{\thedockind}{Research Project} %{Masterthesis}
\newcommand*{\thetitle}{APSSTACLE PROJECT}
\newcommand*{\thesubtitle}{SubTitel SubTitel...}
\newcommand*{\theauthor}{Daniel Leoncio Paredes Zevallos}
\newcommand*{\thematriculationnumber}{7104467} % Matrikelnummer
\newcommand*{\thebirthday}{14.09.1989} % Geburtstag
...
\newcommand*{\thebetreuer}{Prof. Dr. XYZ}
...
\begin{document}
  ...
  \linespread {1.25}\selectfont %Zeilenabstand: 1.25 da er von Haus aus 1.2 ist und 1,25 * 1,2 = 1,5
	...
	\chapter{Wissenschaftliches Arbeiten}
		\input{content/wiarbeiten}
	\chapter{Arbeiten mit \LaTeX}
		\input{content/quellcode}
		\input{content/zeichnungen}
